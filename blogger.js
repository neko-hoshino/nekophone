...
export function renderBloggerApp(store) {
    ...
    if (state.view === 'dashboard') {
        ...
        // 🌟 1. 直播间全屏覆盖层 (彻底修复移动端长文本截断与滚轮失效Bug)
